<main id="main" class="main">
    ...
    <div class="main-container mx-auto">
        ...
        <div class="btn-group mb-3" role="group"> <a href="#" class="btn btn-primary btn-3d" data-bs-toggle="modal"
                data-bs-target="#addBastModal">Tambah Data</a> <a href="#" class="btn btn-success btn-3d"
                data-bs-toggle="modal" data-bs-target="#newFaModal">Tambah Data insert</a> <a
                ...
                <tr class="border-b border-gray-100 even:bg-gray-50 hover:bg-indigo-100/30 transition">
                    ...
                    <td
                        ...
                        <button type="button" class="btn-3d btn-teal text-white text-xs py-1 px-2 btn-detail"
                            data-bs-toggle="modal" data-bs-target="#detailModal1" data-nokontrak="<?= $data['no_kontrak']; ?>"
                        ...
                        <button type="button" class="btn-3d btn-indigo text-white text-xs py-1 px-2 edit-btn"
                            data-bs-toggle="modal" data-bs-target="#editModal1" data-id_bast="<?= $data['id_bast']; ?>"
            ...
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="addBastModalLabel">Tambah Data BAST</h5> <button type="button"
                        class="close" data-bs-dismiss="modal" aria-label="Close"> <span aria-hidden="true">&times;</span>
                    </button>
                </div>
