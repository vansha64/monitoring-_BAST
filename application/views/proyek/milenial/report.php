...
<body>
    <div class="main-container mx-auto">
        ...
        <!-- Export Excel -->
        <form method="GET" action="<?= base_url('User/export_report') ?>" class="mb-3 flex items-center gap-2">
                ...
                <tbody>
                    <?php foreach ($laporan as $row) : ?>
                        <tr>
                            ...
                            <td class="truncate-cell" onclick="showDetail('<?= htmlspecialchars($row['pekerjaan'], ENT_QUOTES); ?>')">
                                <?= $row['pekerjaan']; ?>
                            </td>
                            ...
                            <td class="truncate-cell" onclick="showDetail('<?= htmlspecialchars($row['keterangan'], ENT_QUOTES); ?>')">
                                <?= $row['keterangan']; ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content border-0 shadow-lg rounded-lg">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary px-4 py-2 rounded-md" id="closeModalBtn">Tutup</button>
                </div>
            </div>
        </div>
    </div>
